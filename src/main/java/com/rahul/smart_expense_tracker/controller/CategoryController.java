...
public class CategoryController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<CategoryResponse>> updateCategory(@PathVariable("id") Long categoryId, @Valid @RequestBody CategoryRequest categoryRequest) throws BadRequestException {
        String email=getCurrentUserEmail();
